...
LSAE_INPUT_PATH = mbpc.LSAE_INPUT_PATH

aa_full_malaria_df_path = TEST_DIR / "aa_full_malaria_df.parquet"
aa_full_dengue_df_path = TEST_DIR / "aa_full_dengue_df.parquet"
aa_full_malaria_ds_path = TEST_DIR / "aa_full_malaria_ds.nc"
aa_full_dengue_ds_path = TEST_DIR / "aa_full_dengue_ds.nc"
################################################################
...
if not (mbpc.POPULATION_READ_PATH / "aa_2023_full_population_df.parquet").exists():
    pytest.skip(
