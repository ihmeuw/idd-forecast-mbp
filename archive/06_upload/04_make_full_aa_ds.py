...
from idd_forecast_mbp.lib.io.netcdf import convert_to_xarray, write_netcdf, ensure_id_coordinates_are_integers, read_netcdf_with_integer_ids
import os

best_run_date = "2025_08_11"

PROCESSED_DATA_PATH = mbpc.MODEL_ROOT / "02-processed_data"
MODELING_DATA_PATH = mbpc.MODEL_ROOT / "03-modeling_data"
