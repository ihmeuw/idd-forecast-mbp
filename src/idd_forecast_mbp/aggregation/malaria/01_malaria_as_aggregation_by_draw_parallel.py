...
# Script directory
SCRIPT_ROOT = rfc.REPO_ROOT / repo_name / "src" / package_name / "aggregation" / "malaria"
...
wf_uuid = uuid.uuid4()
tool_name = f"{package_name}_draw_level_malaria_aggregation_{wf_uuid}"
...
task_template = tool.get_task_template(
    ...
    command_template=(
        "python {script_root}/malaria_as_aggregation_by_draw.py "
