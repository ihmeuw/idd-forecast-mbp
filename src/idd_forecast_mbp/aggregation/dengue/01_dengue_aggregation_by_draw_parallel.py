...
# Script directory
SCRIPT_ROOT = rfc.REPO_ROOT / repo_name / "src" / package_name / "aggregation" / "dengue"
...
wf_uuid = uuid.uuid4()
tool_name = f"{package_name}_draw_level_dengue_aggregation_{wf_uuid}"
...
task_template = tool.get_task_template(
    template_name="dengue_aggregation",
    ...
    command_template=(
        "python {script_root}/dengue_aggregation_by_draw.py "
