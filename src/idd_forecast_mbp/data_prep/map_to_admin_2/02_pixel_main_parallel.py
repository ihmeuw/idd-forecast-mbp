...
# Script directory
SCRIPT_ROOT = rfc.REPO_ROOT / repo_name / "src" / package_name / "data_prep" / "map_to_admin_2"
...
heirarchies = ["lsae_1209", "gbd_2023"]
# Jobmon setup
...
for covariate in COVARIATE_DICT.keys():
    ...
    for hiearchy in heirarchies:
        print(f"Creating tasks for covariate: {covariate}, hierarchy: {hiearchy}")
