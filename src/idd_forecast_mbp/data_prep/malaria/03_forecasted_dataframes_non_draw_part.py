...
for ssp_scenario in ssp_scenarios:
    ...
    forecast_df.to_parquet(f"{FORECASTING_DATA_PATH}/malaria_forecast_scenario_{ssp_scenario}_non_draw_part.parquet", index=False)