...
# Script directory
SCRIPT_ROOT = rfc.REPO_ROOT / repo_name / "src" / package_name / "forecasting" / "dengue"
...
wf_uuid = uuid.uuid4()
tool_name = f"{package_name}_forecast_dengue"
...
task_template = tool.get_task_template(
    ...
    command_template=(
        "python {script_root}/forecast_admin_2s.py "
