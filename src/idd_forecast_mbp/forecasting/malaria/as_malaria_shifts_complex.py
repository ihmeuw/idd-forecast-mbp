...
for measure in measure_map:
    ...
    malaria_measure_2022_df["shift_1"] = malaria_measure_2022_df[f"log_malaria_{short}_rate"] - malaria_measure_2022_df[f"log_malaria_{short}_rate_pred_1_raw"]
    malaria_measure_2022_df["shift_2"] = malaria_measure_2022_df[f"log_malaria_{short}_rate"] - malaria_measure_2022_df[f"log_malaria_{short}_rate_pred_2_raw"]
    ...
    malaria_measure_full_df["rate_pred_1"] = malaria_measure_full_df[f"malaria_{short}_rate_baseline_pred_1"] * malaria_measure_full_df["relative_risk_as"]
    malaria_measure_full_df["rate_pred_2"] = malaria_measure_full_df[f"malaria_{short}_rate_baseline_pred_2"] * malaria_measure_full_df["relative_risk_as"]
